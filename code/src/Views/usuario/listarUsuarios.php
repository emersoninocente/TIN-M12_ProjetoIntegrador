<?php
// src/View/usuario/listarUsuarios.php
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="processaDeletarUsuario.php?id=<?php echo $usuario['id'];?>" class="btn-deletar" onclick="return confirm('Tem certeza que deseja deletar o usuário?');">Deletar</a>
