...
try {
    ...
    $result = $livroController->tratarLivros(0,$titulo,$autor,$isbn,$genero,$editora,$resumo,$ano_publicacao,$edicao,$quantidade_paginas,$quantidade_total,$quantidade_disponivel,$capa_url,$ativo);

    if ($result) {
        header('Location: listarLivros.php?sucesso=criado');
        exit;
    } else {
        header('Location: criarLivro.php?erro=criar');
        exit;
    }
